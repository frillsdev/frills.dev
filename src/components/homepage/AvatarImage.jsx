...
export default function AvatarImage() {
  ...
  {
    src: "/images/avatars/AmandaBaeza.png",
  ...
  {
    src: "/images/avatars/makowka_oc_maker.png",
  ...
  {
    src: "/images/avatars/_friend_maker__by_Rowyn.png",
  ...
  {
    src: "/images/avatars/Cutie_Creator_20.png",
  ...
  {
    src: "/images/avatars/scrimsart.png",
  ...
  {
    src: "/images/avatars/anjubatus_heart_hold_char.png",
    ...
    ,
  {
    src: "/images/avatars/andycarolan-pink.png",
  ...
  const avatarIndex = Math.floor(Math.random() * avatarArray.length)


  return <img src={avatarArray[avatarIndex]['src']} alt={avatarArray[avatarIndex]['alt']}/>;
}
